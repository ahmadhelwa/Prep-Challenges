...
let newTest = str.slice(str.lastIndexOf(' ') + 1);
...
const LastWord_2 = (str) => {
    ...
    let newTest2 =  str.split(' ');

  let  number = newTest2.length-1;

    return   newTest2[number] ;
}
// -------------------------------------------------------------------------------------------------------
...
const replaceWords = (str) => {
    ...
    let newTest1 =  str.split(' ');
 for (let i = 0; i < newTest1.length; i++) {
     

    if(newTest1[i]=="I")
    newTest1.splice(i , 1 , "We")

    else if(newTest1[i]=="was")
     newTest1.splice(i,1,"were")

    else if(newTest1[i]=="am")
     newTest1.splice(i,1,"are")
