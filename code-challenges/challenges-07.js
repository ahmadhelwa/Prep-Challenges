...
const objLat = (obj) => {
    ...
    let information = `my name is ${firstname1} ${lastname1} I am ${obj.age} YO, and I love ${obj.hobby}.`;
    return information;
};
// -------------------------------------------------------------------------------------------------------
...
const cvFormatter = (arr) => {
    ...
    for (let i = 0; i < arr.length; i++) {
        ...
        if (arr[i].lastName === null && arr[i].yearsOfExperience > 1) {
            arrayname .push({ fullName: `${arr[i].firstName}`, tech: `${arr[i].tech}`});

        } else if (arr[i].yearsOfExperience > 1) {
            arrayname .push({ fullName: `${arr[i].firstName} ${arr[i].lastName}`, tech: `${arr[i].tech}`});
        } else continue;
    } return  arrayname ;
};
// -------------------------------------------------------------------------------------------------------
